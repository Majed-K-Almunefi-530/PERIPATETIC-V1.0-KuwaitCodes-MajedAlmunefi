...
public class Africares extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_africares);
        ...
        book p1 =new book(R.drawable.stack ,"The stack " , R.drawable.web1 , R.drawable.location);
        book p2 =new book(R.drawable.letetete ,"Le Tête" , R.drawable.web1 , R.drawable.location);
        book p3 =new book(R.drawable.nourished ,"Nourish'd" , R.drawable.web1 , R.drawable.location);
        ...
        AfricaresAdapter booker = new AfricaresAdapter(books,this);
                ...
                .withOnDrawerItemClickListener (new Drawer.OnDrawerItemClickListener () {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (Africares.this,Africabookhotel.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (Africares.this,Africamalls.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==3) {
                            ...
                            Intent c = new Intent (Africares.this, Africaparks.class);
                            startActivity (c);
                        }

                        if(drawerItem.getIdentifier ()==4) {

                            Intent d = new Intent (Africares.this, Africares.class);
                            startActivity (d);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==8) {
                            ...
                            Intent g = new Intent (Africares.this, contact_us.class);
                            startActivity (g);
                        }

                        if(drawerItem.getIdentifier ()==9) {

                            Intent h = new Intent (Africares.this, Name_page.class);
                            startActivity (h);
                        }

                        if(drawerItem.getIdentifier ()==10) {

                            Intent i = new Intent (Africares.this, aboutus.class);
                            startActivity (i);
                        }

                        if(drawerItem.getIdentifier ()==11) {

                            Intent i = new Intent (Africares.this, Africainfoorbook.class);
                            startActivity (i);
                        }
                        return false;
                    }
