...
public class ChooseinAfarica extends AppCompatActivity {

    ViewPager viewPager;
    AfricaCountryAdapter myadapter;
    List<Model> mymodels;
    Integer[] colors =null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choosein_afarica);
        ...
        mymodels.add(new Model(R.drawable.southafrica,"South Africa","South Africa is a country on the southernmost tip of the African continent."));
        mymodels.add(new Model(R.drawable.egyegy,"Egypt","Egypt, a country linking northeast Africa with the Middle East, dates to the time of the pharaohs."));
        ...
        myadapter = new AfricaCountryAdapter(mymodels,this);
