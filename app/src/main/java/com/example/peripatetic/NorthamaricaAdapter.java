...
public class NorthamaricaAdapter extends PagerAdapter {
    ...
    public NorthamaricaAdapter(List<Model> models, Context context) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (position == 0){
                    Intent a = new Intent(context,Orlando.class);
