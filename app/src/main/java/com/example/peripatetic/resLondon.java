...
public class resLondon extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_res_london);


        ArrayList<book> books = new ArrayList<>();

        book p1 =new book(R.drawable.nac ,"nac " , R.drawable.web1 , R.drawable.location);
        book p2 =new book(R.drawable.ask ,"ASK" , R.drawable.web1 , R.drawable.location);
        book p3 =new book(R.drawable.nobikov ,"Novikov" , R.drawable.web1 , R.drawable.location);
                ...
                .withOnDrawerItemClickListener (new Drawer.OnDrawerItemClickListener () {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (resLondon.this,ukhotel.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (resLondon.this,malllac.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==3) {
                            ...
                            Intent c = new Intent (resLondon.this, LondonParkActivity.class);
                            startActivity (c);
                        }

                        if(drawerItem.getIdentifier ()==4) {

                            Intent d = new Intent (resLondon.this, resLondon.class);
                            startActivity (d);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==8) {
                            ...
                            Intent g = new Intent (resLondon.this, contact_us.class);
                            startActivity (g);
                        }

                        if(drawerItem.getIdentifier ()==9) {

                            Intent h = new Intent (resLondon.this, Name_page.class);
                            startActivity (h);
                        }

                        if(drawerItem.getIdentifier ()==10) {

                            Intent i = new Intent (resLondon.this, aboutus.class);
                            startActivity (i);
                        }

                        if(drawerItem.getIdentifier ()==11) {

                            Intent i = new Intent (resLondon.this, ukinfoorbook.class);
                            startActivity (i);
                        }
                        return false;
                    }
