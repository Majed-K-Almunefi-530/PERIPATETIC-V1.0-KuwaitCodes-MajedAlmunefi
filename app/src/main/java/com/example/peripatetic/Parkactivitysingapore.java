...
public class Parkactivitysingapore extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_parkactivitysingapore);
        ArrayList<book> books = new ArrayList<>();

        book p1 =new book(R.drawable.unistudiosinga ,"Universal " , R.drawable.web1 , R.drawable.location);
        book p2 =new book(R.drawable.sentosa ,"Sentosa" , R.drawable.web1 , R.drawable.location);
        book p3 =new book(R.drawable.adventurecove ,"Adv. cove" , R.drawable.web1 , R.drawable.location);
        ...
        ParkAdapter booker = new ParkAdapter(books,this);
                ...
                .withOnDrawerItemClickListener (new Drawer.OnDrawerItemClickListener () {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (Parkactivitysingapore.this,singabooktickets.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (Parkactivitysingapore.this,Mallbook.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==3) {
                            ...
                            Intent c = new Intent (Parkactivitysingapore.this, Parkactivitysingapore.class);
                            startActivity (c);
                        }

                        if(drawerItem.getIdentifier ()==4) {

                            Intent d = new Intent (Parkactivitysingapore.this, resturante.class);
                            startActivity (d);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==8) {
                            ...
                            Intent g = new Intent (Parkactivitysingapore.this, contact_us.class);
                            startActivity (g);
                        }

                        if(drawerItem.getIdentifier ()==9) {

                            Intent h = new Intent (Parkactivitysingapore.this, Name_page.class);
                            startActivity (h);
                        }

                        if(drawerItem.getIdentifier ()==10) {

                            Intent i = new Intent (Parkactivitysingapore.this, aboutus.class);
                            startActivity (i);
                        }

                        if(drawerItem.getIdentifier ()==11) {

                            Intent i = new Intent (Parkactivitysingapore.this, singaporecitychoose.class);
                            startActivity (i);
                        }
                        return false;
                    }
