...
public class resturante extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        book p1 =new book(R.drawable.odette ,"Odette " , R.drawable.web1 , R.drawable.location);
        book p2 =new book(R.drawable.ibid ,"Ibid" , R.drawable.web1 , R.drawable.location);
        book p3 =new book(R.drawable.rubicon ,"Rubicon" , R.drawable.web1 , R.drawable.location);
        ...
        ResAdapter booker = new ResAdapter(books,this);
                ...
                .withOnDrawerItemClickListener (new Drawer.OnDrawerItemClickListener () {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (resturante.this,singabooktickets.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (resturante.this,Mallbook.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==3) {
                            ...
                            Intent c = new Intent (resturante.this, Parkactivitysingapore.class);
                            startActivity (c);
                        }

                        if(drawerItem.getIdentifier ()==4) {

                            Intent d = new Intent (resturante.this, resturante.class);
                            startActivity (d);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==8) {
                            ...
                            Intent g = new Intent (resturante.this, contact_us.class);
                            startActivity (g);
                        }

                        if(drawerItem.getIdentifier ()==9) {

                            Intent h = new Intent (resturante.this, Name_page.class);
                            startActivity (h);
                        }

                        if(drawerItem.getIdentifier ()==10) {

                            Intent i = new Intent (resturante.this, aboutus.class);
                            startActivity (i);
                        }

                        if(drawerItem.getIdentifier ()==11) {

                            Intent i = new Intent (resturante.this, singaporecitychoose.class);
                            startActivity (i);
                        }
                        return false;
                    }
