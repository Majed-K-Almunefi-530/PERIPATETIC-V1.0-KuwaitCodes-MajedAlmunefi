...
public class Africaparks extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_africaparks);
        ...
        book p1 =new book(R.drawable.ostrich ,"Ostrich Farm" , R.drawable.web1 , R.drawable.location);
        book p2 =new book(R.drawable.mtn ,"Table Mtn." , R.drawable.web1 , R.drawable.location);
        book p3 =new book(R.drawable.sandsand ,"Sandboard" , R.drawable.web1 , R.drawable.location);
                ...
                .withOnDrawerItemClickListener (new Drawer.OnDrawerItemClickListener () {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (Africaparks.this,Africabookhotel.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (Africaparks.this,Africamalls.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==3) {
                            ...
                            Intent c = new Intent (Africaparks.this, Africaparks.class);
                            startActivity (c);
                        }

                        if(drawerItem.getIdentifier ()==4) {

                            Intent d = new Intent (Africaparks.this, Africares.class);
                            startActivity (d);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==8) {
                            ...
                            Intent g = new Intent (Africaparks.this, contact_us.class);
                            startActivity (g);
                        }

                        if(drawerItem.getIdentifier ()==9) {

                            Intent h = new Intent (Africaparks.this, Name_page.class);
                            startActivity (h);
                        }

                        if(drawerItem.getIdentifier ()==10) {

                            Intent i = new Intent (Africaparks.this, aboutus.class);
                            startActivity (i);
                        }

                        if(drawerItem.getIdentifier ()==11) {

                            Intent i = new Intent (Africaparks.this, Africainfoorbook.class);
                            startActivity (i);
                        }
                        return false;
                    }
