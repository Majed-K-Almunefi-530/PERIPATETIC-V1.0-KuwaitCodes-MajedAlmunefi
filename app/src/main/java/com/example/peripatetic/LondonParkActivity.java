...
public class LondonParkActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_london_park);


        ArrayList<book> books = new ArrayList<>();

        book p1 =new book(R.drawable.eye ,"London eye" , R.drawable.web1 , R.drawable.location);
        book p2 =new book(R.drawable.paradise ,"Paradise" , R.drawable.web1 , R.drawable.location);
        book p3 =new book(R.drawable.bigben ,"big ben" , R.drawable.web1 , R.drawable.location);
        ...
        LondonParksAdapter booker = new LondonParksAdapter(books,this);
                ...
                .withOnDrawerItemClickListener (new Drawer.OnDrawerItemClickListener () {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (LondonParkActivity.this,ukhotel.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (LondonParkActivity.this,malllac.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==8) {
                            ...
                            Intent g = new Intent (LondonParkActivity.this, contact_us.class);
                            startActivity (g);
                        }

                        if(drawerItem.getIdentifier ()==9) {

                            Intent h = new Intent (LondonParkActivity.this, Name_page.class);
                            startActivity (h);
                        }

                        if(drawerItem.getIdentifier ()==10) {

                            Intent i = new Intent (LondonParkActivity.this, aboutus.class);
                            startActivity (i);
                        }

                        if(drawerItem.getIdentifier ()==11) {

                            Intent i = new Intent (LondonParkActivity.this, ukinfoorbook.class);
                            startActivity (i);
                        }
                        return false;
                    }
