...
public class OrlandoParks extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_orlando_parks);
        ...
        book p1 =new book(R.drawable.dis ,"Disney" , R.drawable.web1 , R.drawable.location);
        book p2 =new book(R.drawable.univer ,"Universal" , R.drawable.web1 , R.drawable.location);
        book p3 =new book(R.drawable.seaworld ,"Sea world" , R.drawable.web1 , R.drawable.location);
        ...
        OrlandoParksAdapter booker = new OrlandoParksAdapter(books,this);
                ...
                .withOnDrawerItemClickListener (new Drawer.OnDrawerItemClickListener () {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (OrlandoParks.this,activitybookhotel.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (OrlandoParks.this,MallInOrlando.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==3) {
                            ...
                            Intent c = new Intent (OrlandoParks.this, OrlandoParks.class);
                            startActivity (c);
                        }

                        if(drawerItem.getIdentifier ()==4) {

                            Intent d = new Intent (OrlandoParks.this, ResturanteInOrlando.class);
                            startActivity (d);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==8) {
                            ...
                            Intent g = new Intent (OrlandoParks.this, contact_us.class);
                            startActivity (g);
                        }

                        if(drawerItem.getIdentifier ()==9) {

                            Intent h = new Intent (OrlandoParks.this, Name_page.class);
                            startActivity (h);
                        }

                        if(drawerItem.getIdentifier ()==10) {

                            Intent i = new Intent (OrlandoParks.this, aboutus.class);
                            startActivity (i);
                        }

                        if(drawerItem.getIdentifier ()==11) {

                            Intent i = new Intent (OrlandoParks.this, orlandoinfoorbook.class);
                            startActivity (i);
                        }
                        return false;
                    }
