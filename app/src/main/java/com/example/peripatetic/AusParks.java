...
public class AusParks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        book p1 =new book(R.drawable.sydsydsydopop ,"Opera house" , R.drawable.web1 , R.drawable.location);
        book p2 =new book(R.drawable.bondi ,"Bondi beach" , R.drawable.web1 , R.drawable.location);
        book p3 =new book(R.drawable.taronga ,"Taronga" , R.drawable.web1 , R.drawable.location);
                ...
                .withOnDrawerItemClickListener (new Drawer.OnDrawerItemClickListener () {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (AusParks.this,AusBookHotel.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (AusParks.this,AusMalls.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==3) {
                            ...
                            Intent c = new Intent (AusParks.this, AusParks.class);
                            startActivity (c);
                        }

                        if(drawerItem.getIdentifier ()==4) {

                            Intent d = new Intent (AusParks.this, Ausres.class);
                            startActivity (d);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==8) {
                            ...
                            Intent g = new Intent (AusParks.this, contact_us.class);
                            startActivity (g);
                        }

                        if(drawerItem.getIdentifier ()==9) {

                            Intent h = new Intent (AusParks.this, Name_page.class);
                            startActivity (h);
                        }

                        if(drawerItem.getIdentifier ()==10) {

                            Intent i = new Intent (AusParks.this, aboutus.class);
                            startActivity (i);
                        }

                        if(drawerItem.getIdentifier ()==11) {

                            Intent i = new Intent (AusParks.this, Ausinfoorbook.class);
                            startActivity (i);
                        }
                        return false;
                    }
