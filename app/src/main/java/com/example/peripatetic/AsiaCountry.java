...
public class AsiaCountry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asia_country);
        ...
        mymodels.add(new Model(R.drawable.singapore,"singapore","Singapore, officially the Republic of Singapore, is a sovereign island city-state in Southeast Asia."));
        mymodels.add(new Model(R.drawable.japan,"Japan","Japan is an island country of East Asia in the northwest Pacific Ocean. "));
        ...
        myadapter = new Myadapter(mymodels,this);
