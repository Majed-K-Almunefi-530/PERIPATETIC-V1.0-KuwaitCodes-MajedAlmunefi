...
public class MallInOrlando extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mall_in_orlando);



        ArrayList<book> books = new ArrayList<>();

        book p1 =new book(R.drawable.floridamall ,"Florida mall " , R.drawable.web1 , R.drawable.location);
        book p2 =new book(R.drawable.melania ,"Millenia" , R.drawable.web1 , R.drawable.location);
        book p3 =new book(R.drawable.premiumoutout ,"Prem. outlet" , R.drawable.web1 , R.drawable.location);
        ...
        MallInOrlandoAdapter booker = new MallInOrlandoAdapter(books,this);
                ...
                .withOnDrawerItemClickListener (new Drawer.OnDrawerItemClickListener () {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (MallInOrlando.this,activitybookhotel.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (MallInOrlando.this,MallInOrlando.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==3) {
                            ...
                            Intent c = new Intent (MallInOrlando.this, OrlandoParks.class);
                            startActivity (c);
                        }

                        if(drawerItem.getIdentifier ()==4) {

                            Intent d = new Intent (MallInOrlando.this, ResturanteInOrlando.class);
                            startActivity (d);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==8) {
                            ...
                            Intent g = new Intent (MallInOrlando.this, contact_us.class);
                            startActivity (g);
                        }

                        if(drawerItem.getIdentifier ()==9) {

                            Intent h = new Intent (MallInOrlando.this, Name_page.class);
                            startActivity (h);
                        }

                        if(drawerItem.getIdentifier ()==10) {

                            Intent i = new Intent (MallInOrlando.this, aboutus.class);
                            startActivity (i);
                        }
                        if(drawerItem.getIdentifier ()==11) {

                            Intent i = new Intent (MallInOrlando.this, orlandoinfoorbook.class);
                            startActivity (i);
                        }
                        return false;
                    }
