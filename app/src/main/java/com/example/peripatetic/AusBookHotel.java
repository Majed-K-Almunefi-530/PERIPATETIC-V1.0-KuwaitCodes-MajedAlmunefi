...
public class AusBookHotel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aus_book_hotel);
        ...
        book p1 =new book(R.drawable.shangrilasydney ,"Shangri-la" , R.drawable.web1 , R.drawable.location);
        book p2 =new book(R.drawable.intercontinental ,"intercont." , R.drawable.web1 , R.drawable.location);
        book p3 =new book(R.drawable.hiltonsydsyd ,"Hilton " , R.drawable.web1 , R.drawable.location);
        ...
        @SuppressLint("ResourceAsColor") AccountHeader hr = new AccountHeaderBuilder()
                .withActivity (this)
                .withHeaderBackground (R.drawable.australia)
                ...
                .withOnDrawerItemClickListener (new Drawer.OnDrawerItemClickListener () {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (AusBookHotel.this,AusBookHotel.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (AusBookHotel.this,AusMalls.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==3) {
                            ...
                            Intent c = new Intent (AusBookHotel.this, AusParks.class);
                            startActivity (c);
                        }

                        if(drawerItem.getIdentifier ()==4) {

                            Intent d = new Intent (AusBookHotel.this, Ausres.class);
                            startActivity (d);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==8) {
                            ...
                            Intent g = new Intent (AusBookHotel.this, contact_us.class);
                            startActivity (g);
                        }

                        if(drawerItem.getIdentifier ()==9) {

                            Intent h = new Intent (AusBookHotel.this, Name_page.class);
                            startActivity (h);
                        }

                        if(drawerItem.getIdentifier ()==10) {

                            Intent i = new Intent (AusBookHotel.this, aboutus.class);
                            startActivity (i);
                        }
                        if(drawerItem.getIdentifier ()==11) {

                            Intent i = new Intent (AusBookHotel.this, Ausinfoorbook.class);
                            startActivity (i);
                        }
                        return false;
                    }
