...
public class malllac extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_malllac);
        ArrayList<book> books = new ArrayList<>();

        book p1 =new book(R.drawable.westfield ,"westfield " , R.drawable.web1 , R.drawable.location);
        book p2 =new book(R.drawable.harrods ,"Harrods" , R.drawable.web1 , R.drawable.location);
        book p3 =new book(R.drawable.selfridges ,"Selfridges" , R.drawable.web1 , R.drawable.location);
        ...
        mallukAdapter booker = new mallukAdapter(books,this);
                ...
                .withOnDrawerItemClickListener (new Drawer.OnDrawerItemClickListener () {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (malllac.this,ukhotel.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (malllac.this,malllac.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==3) {
                            ...
                            Intent c = new Intent (malllac.this, LondonParkActivity.class);
                            startActivity (c);
                        }

                        if(drawerItem.getIdentifier ()==4) {

                            Intent d = new Intent (malllac.this, resLondon.class);
                            startActivity (d);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==8) {
                            ...
                            Intent g = new Intent (malllac.this, contact_us.class);
                            startActivity (g);
                        }

                        if(drawerItem.getIdentifier ()==9) {

                            Intent h = new Intent (malllac.this, Name_page.class);
                            startActivity (h);
                        }

                        if(drawerItem.getIdentifier ()==10) {

                            Intent i = new Intent (malllac.this, aboutus.class);
                            startActivity (i);
                        }
                        if(drawerItem.getIdentifier ()==11) {

                            Intent i = new Intent (malllac.this, ukinfoorbook.class);
                            startActivity (i);
                        }
                        return false;
                    }
