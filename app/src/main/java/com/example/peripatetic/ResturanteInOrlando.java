...
public class ResturanteInOrlando extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_resturante_in_orlando);
        ...
        book p1 =new book(R.drawable.buca ,"Buca " , R.drawable.web1 , R.drawable.location);
        book p2 =new book(R.drawable.keke ,"Keke's" , R.drawable.web1 , R.drawable.location);
        book p3 =new book(R.drawable.nobikov ,"Margaritavil" , R.drawable.web1 , R.drawable.location);
                ...
                .withOnDrawerItemClickListener (new Drawer.OnDrawerItemClickListener () {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (ResturanteInOrlando.this,activitybookhotel.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (ResturanteInOrlando.this,MallInOrlando.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==3) {
                            ...
                            Intent c = new Intent (ResturanteInOrlando.this, OrlandoParks.class);
                            startActivity (c);
                        }

                        if(drawerItem.getIdentifier ()==4) {

                            Intent d = new Intent (ResturanteInOrlando.this, ResturanteInOrlando.class);
                            startActivity (d);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==8) {
                            ...
                            Intent g = new Intent (ResturanteInOrlando.this, contact_us.class);
                            startActivity (g);
                        }

                        if(drawerItem.getIdentifier ()==9) {

                            Intent h = new Intent (ResturanteInOrlando.this, Name_page.class);
                            startActivity (h);
                        }

                        if(drawerItem.getIdentifier ()==10) {

                            Intent i = new Intent (ResturanteInOrlando.this, aboutus.class);
                            startActivity (i);
                        }

                        if(drawerItem.getIdentifier ()==11) {

                            Intent i = new Intent (ResturanteInOrlando.this, orlandoinfoorbook.class);
                            startActivity (i);
                        }
                        return false;
                    }
