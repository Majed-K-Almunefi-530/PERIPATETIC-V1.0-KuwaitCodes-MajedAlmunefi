...
public class Mallbook extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mallbook);
        ArrayList<book> books = new ArrayList<>();

        book p1 =new book(R.drawable.vivocity ,"VivoCity " , R.drawable.web1 , R.drawable.location);
        book p2 =new book(R.drawable.mrin ,"Marina sq." , R.drawable.web1 , R.drawable.location);
        book p3 =new book(R.drawable.paragon ,"Paragon" , R.drawable.web1 , R.drawable.location);
        ...
        Mallclass booker = new Mallclass(books,this);
                ...
                .withOnDrawerItemClickListener (new Drawer.OnDrawerItemClickListener () {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (Mallbook.this,singabooktickets.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (Mallbook.this,Mallbook.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==3) {
                            ...
                            Intent c = new Intent (Mallbook.this, Parkactivitysingapore.class);
                            startActivity (c);
                        }

                        if(drawerItem.getIdentifier ()==4) {

                            Intent d = new Intent (Mallbook.this, resturante.class);
                            startActivity (d);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==8) {
                            ...
                            Intent g = new Intent (Mallbook.this, contact_us.class);
                            startActivity (g);
                        }

                        if(drawerItem.getIdentifier ()==9) {

                            Intent h = new Intent (Mallbook.this, Name_page.class);
                            startActivity (h);
                        }

                        if(drawerItem.getIdentifier ()==10) {

                            Intent i = new Intent (Mallbook.this, aboutus.class);
                            startActivity (i);
                        }
                        if(drawerItem.getIdentifier ()==11) {

                            Intent i = new Intent (Mallbook.this, singaporecitychoose.class);
                            startActivity (i);
                        }
                        return false;
                    }
