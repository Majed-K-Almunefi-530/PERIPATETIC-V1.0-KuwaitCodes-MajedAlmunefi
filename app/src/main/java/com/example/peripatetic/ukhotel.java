...
public class ukhotel extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ukhotel);



        ArrayList<book> books = new ArrayList<>();

        book p1 =new book(R.drawable.parklane ,"Park Lane " , R.drawable.web1 , R.drawable.location);
        book p2 =new book(R.drawable.churhcill ,"Churchill " , R.drawable.web1 , R.drawable.location);
        book p3 =new book(R.drawable.grosnver ,"Grosvenor" , R.drawable.web1 , R.drawable.location);
        ...
        bookAdapterukhotel bookerr = new bookAdapterukhotel(books,this);
        ...
        @SuppressLint("ResourceAsColor") AccountHeader hr = new AccountHeaderBuilder()
                .withActivity (this)
                .withHeaderBackground (R.drawable.uk)
                ...
                .withOnDrawerItemClickListener (new Drawer.OnDrawerItemClickListener () {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (ukhotel.this,singabooktickets.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (ukhotel.this,malllac.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==3) {
                            ...
                            Intent c = new Intent (ukhotel.this, LondonParkActivity.class);
                            startActivity (c);
                        }

                        if(drawerItem.getIdentifier ()==4) {

                            Intent d = new Intent (ukhotel.this, resLondon.class);
                            startActivity (d);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==8) {
                            ...
                            Intent g = new Intent (ukhotel.this, contact_us.class);
                            startActivity (g);
                        }

                        if(drawerItem.getIdentifier ()==9) {

                            Intent h = new Intent (ukhotel.this, Name_page.class);
                            startActivity (h);
                        }

                        if(drawerItem.getIdentifier ()==10) {

                            Intent i = new Intent (ukhotel.this, aboutus.class);
                            startActivity (i);
                        }
                        if(drawerItem.getIdentifier ()==11) {

                            Intent i = new Intent (ukhotel.this, ukinfoorbook.class);
                            startActivity (i);
                        }
                        return false;
                    }
