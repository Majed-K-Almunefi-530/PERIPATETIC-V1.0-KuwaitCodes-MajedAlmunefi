...
public class AusMalls extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_aus_malls);
        ...
        book p1 =new book(R.drawable.westwestsysys ,"Westfield " , R.drawable.web1 , R.drawable.location);
        book p2 =new book(R.drawable.worlld ,"World Sq." , R.drawable.web1 , R.drawable.location);
        book p3 =new book(R.drawable.glasshouse ,"glasshouse" , R.drawable.web1 , R.drawable.location);
        ...
        AusMallsAdapter booker = new AusMallsAdapter(books,this);
                ...
                .withOnDrawerItemClickListener (new Drawer.OnDrawerItemClickListener () {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (AusMalls.this,AusBookHotel.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (AusMalls.this,AusMalls.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==3) {
                            ...
                            Intent c = new Intent (AusMalls.this, AusParks.class);
                            startActivity (c);
                        }

                        if(drawerItem.getIdentifier ()==4) {

                            Intent d = new Intent (AusMalls.this, Ausres.class);
                            startActivity (d);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==8) {
                            ...
                            Intent g = new Intent (AusMalls.this, contact_us.class);
                            startActivity (g);
                        }

                        if(drawerItem.getIdentifier ()==9) {

                            Intent h = new Intent (AusMalls.this, Name_page.class);
                            startActivity (h);
                        }

                        if(drawerItem.getIdentifier ()==10) {

                            Intent i = new Intent (AusMalls.this, aboutus.class);
                            startActivity (i);
                        }
                        if(drawerItem.getIdentifier ()==11) {

                            Intent i = new Intent (AusMalls.this, Ausinfoorbook.class);
                            startActivity (i);
                        }
                        return false;
                    }
