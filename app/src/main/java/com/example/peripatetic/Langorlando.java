...
public class Langorlando extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_langorlando);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_recents:
                        Intent i = new Intent(Langorlando.this,Langorlando.class);
                        startActivity(i);
                        break;
                    case R.id.action_favorites:
                        Intent b = new Intent(Langorlando.this,Embassyorlando.class);
                        startActivity(b);
                        break;
                    case R.id.goback:
                        Intent c = new Intent(Langorlando.this,orlandoinfoorbook.class);
                        startActivity(c);
                        break;
                    case R.id.action_nearby:
                        Intent d = new Intent(Langorlando.this,convertmoneyorlando.class);
                        startActivity(d);
                        break;
                }
                return true;
