...
public class activitybookhotel extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activitybookhotel);
        ...
        book p1 =new book(R.drawable.hiltonorlando ,"Hilton " , R.drawable.web1 , R.drawable.location);
        book p2 =new book(R.drawable.jwmarriotorlando ,"JW marriot " , R.drawable.web1 , R.drawable.location);
        book p3 =new book(R.drawable.ritzritz ,"Ritz carlton" , R.drawable.web1 , R.drawable.location);
        ...
        bookadapterorlando bookerr = new bookadapterorlando(books,this);
                ...
                .withOnDrawerItemClickListener (new Drawer.OnDrawerItemClickListener () {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (activitybookhotel.this,activitybookhotel.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (activitybookhotel.this,MallInOrlando.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==3) {
                            ...
                            Intent c = new Intent (activitybookhotel.this, OrlandoParks.class);
                            startActivity (c);
                        }

                        if(drawerItem.getIdentifier ()==4) {

                            Intent d = new Intent (activitybookhotel.this, ResturanteInOrlando.class);
                            startActivity (d);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==8) {
                            ...
                            Intent g = new Intent (activitybookhotel.this, contact_us.class);
                            startActivity (g);
                        }

                        if(drawerItem.getIdentifier ()==9) {

                            Intent h = new Intent (activitybookhotel.this, Name_page.class);
                            startActivity (h);
                        }

                        if(drawerItem.getIdentifier ()==10) {

                            Intent i = new Intent (activitybookhotel.this, aboutus.class);
                            startActivity (i);
                        }
                        if(drawerItem.getIdentifier ()==11) {

                            Intent i = new Intent (activitybookhotel.this, orlandoinfoorbook.class);
                            startActivity (i);
                        }
                        return false;
                    }
